...
import org.owntracks.android.gms.location.GMSActivityRecognitionClient
...
class ServiceModule {
  ...
  @Provides
  @ServiceScoped
  fun getActivityRecognitionClient(service: Service): ActivityRecognitionClient =
      GMSActivityRecognitionClient.create(service)
}
