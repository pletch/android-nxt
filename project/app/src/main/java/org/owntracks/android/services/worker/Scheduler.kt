...
constructor(
   ...
   *
   * [replaceExisting] is for the one caller that genuinely needs to re-arm — a changed ping
   * interval — where the running schedule is stale by definition.
   */
